...
array( "name" => "Enable Autoplay for Fullscreen Slideshow",
	"desc" => "",
	"id" => $shortname."_auto_play",
	"type" => "iphone_checkboxes",
	"std" => 1
),
...
array( "name" => "Enable fullscreen gallery thumbnails",
	"desc" => "",
	"id" => $shortname."_display_slideshow_thumb",
	"type" => "iphone_checkboxes",
	"std" => 1
),
